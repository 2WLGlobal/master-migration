...
WHERE MENU_NAME = 'MSMT_TYP'

SELECT * FROM SECPDTA.B2B_CDTY WHERE  CODE_TYPE = 'MSMT_TYP'

UPDATE SECPDTA.B2B_CDTY
SET KEY_COLUMNS = LOWER(KEY_COLUMNS)
WHERE CODE_TYPE = 'MSMT_TYP'


SELECT * FROM SECPDTA.B2B_MTDT WHERE CODE_TYPE='MSMT_TYP'
