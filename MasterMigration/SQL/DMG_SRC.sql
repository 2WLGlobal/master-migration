...
WHERE MENU_NAME = 'DAMAGE_SOURCE'

SELECT * FROM SECPDTA.B2B_CDTY WHERE  CODE_TYPE = 'DMG_SRC'

UPDATE SECPDTA.B2B_CDTY
SET KEY_COLUMNS = LOWER(KEY_COLUMNS)
WHERE CODE_TYPE = 'DMG_SRC'


SELECT * FROM SECPDTA.B2B_MTDT WHERE CODE_TYPE='DMG_SRC'
