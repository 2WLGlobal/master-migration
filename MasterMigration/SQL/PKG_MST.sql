...
WHERE MENU_NAME = 'PACKAGE_MASTER'

SELECT * FROM SECPDTA.B2B_CDTY WHERE  CODE_TYPE = 'PKG_MST'

UPDATE SECPDTA.B2B_CDTY
SET KEY_COLUMNS = LOWER(KEY_COLUMNS)
WHERE CODE_TYPE = 'PKG_MST'


SELECT * FROM SECPDTA.B2B_MTDT WHERE CODE_TYPE='PKG_MST'
