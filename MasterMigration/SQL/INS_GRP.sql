...
WHERE MENU_NAME = 'INSTALL_GROUP'

SELECT * FROM SECPDTA.B2B_CDTY WHERE  CODE_TYPE = 'INS_GRP'

UPDATE SECPDTA.B2B_CDTY
SET KEY_COLUMNS = LOWER(KEY_COLUMNS)
WHERE CODE_TYPE = 'INS_GRP'


SELECT * FROM SECPDTA.B2B_MTDT WHERE CODE_TYPE='INS_GRP'
