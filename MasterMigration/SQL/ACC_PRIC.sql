...
WHERE MENU_NAME = 'ACCESSORY_PRICE'

SELECT * FROM SECPDTA.B2B_CDTY WHERE  CODE_TYPE = 'ACC_PRIC'

UPDATE SECPDTA.B2B_CDTY
SET KEY_COLUMNS = LOWER(KEY_COLUMNS)
WHERE CODE_TYPE = 'ACC_PRIC'


SELECT * FROM SECPDTA.B2B_MTDT WHERE CODE_TYPE='ACC_PRIC'
