...
WHERE MENU_NAME = 'INS_AUT'

SELECT * FROM SECPDTA.B2B_CDTY WHERE  CODE_TYPE = 'INS_AUT'

UPDATE SECPDTA.B2B_CDTY
SET KEY_COLUMNS = LOWER(KEY_COLUMNS)
WHERE CODE_TYPE = 'INS_AUT'


SELECT * FROM SECPDTA.B2B_MTDT WHERE CODE_TYPE='INS_AUT'
