...
WHERE MENU_NAME = 'DAMAGE_SEVERITY'

SELECT * FROM SECPDTA.B2B_CDTY WHERE  CODE_TYPE = 'DMG_SEV'

UPDATE SECPDTA.B2B_CDTY
SET KEY_COLUMNS = LOWER(KEY_COLUMNS)
WHERE CODE_TYPE = 'DMG_SEV'


SELECT * FROM SECPDTA.B2B_MTDT WHERE CODE_TYPE='DMG_SEV'
